...
downloadit-open-ariang =
    .label = Open AriaNg
    .accesskey = A
downloadit-restart-required-title = Restart Firefox
downloadit-restart-after-install = DownloadIt has been installed. Restart Firefox now to finish initializing it?
downloadit-restart-after-upgrade = DownloadIt has been upgraded. Restart Firefox now to finish applying the update?
...
downloadit-magnet-manager-eyebrow = protocol route
downloadit-magnet-manager-title = Default magnet downloader
downloadit-magnet-manager-label = Magnet links
downloadit-magnet-manager-help = Automatically send standard magnet links to this external downloader.
downloadit-ed2k-manager-eyebrow = protocol route
downloadit-ed2k-manager-title = Default ed2k downloader
downloadit-ed2k-manager-label = ed2k links
downloadit-ed2k-manager-help = Automatically send ed2k links to this external downloader.
...
downloadit-aria2next-conf-path-label = Custom aria2 configuration file (optional)
downloadit-aria2next-conf-path-help = If set, this conf file is loaded first. DownloadIt then overrides RPC settings via a managed conf.
...
downloadit-about-callout-mark =
    .aria-label = Show a DownloadIt log
downloadit-easter-egg-log-1 = A girl confessed today that she liked me, but my heart belongs only to you. I turned her down immediately. She said she would not give up. My heart still has room for only you.
downloadit-easter-egg-log-2 = The team leader came to relieve me at midnight. I did not hear a car horn because I was watching you take out the trash in pajamas on the monitor. I stared so intently that I smiled like an idiot, so the team leader scolded me and docked a day's pay. I feel wronged. I want a hug. The instant noodles you gave me were delicious.
downloadit-easter-egg-log-3 = I sent you hundreds of messages and you never replied. I was about to stop caring, but then you suddenly answered with “嗯”. My happiness came back. Hahahahaha.
downloadit-easter-egg-log-4 = I am done being a simp. From now on, you walk your single-plank bridge while I support it from below. Watch your step. I would be heartbroken if you fell.
downloadit-easter-egg-log-5 = You must miss me, right? Can you reply now? I bought a muscle patch because your back must hurt after exercising all night. Come home early tonight. I made rib soup for you. I will always wait for you at home.
downloadit-easter-egg-log-6 = I heard you wanted a makeup set. I calculated it: if I carry bricks at a construction site tomorrow, I can earn 200 yuan. Add the pocket money I saved last month, and I can just afford a Dior set for you.
downloadit-easter-egg-log-7 = Today I changed your contact note to “The other person is typing...”. Now I know you do not ignore me; you are just thinking about how to reply. That means I am in your heart too.
downloadit-easter-egg-log-8 = McDonald's buckets are half price today, so I bought one for you. I wanted to say that buckets are half price, but my love for you is priceless. I am so clumsy: I cannot say how much I love you, and I cannot even protect the bucket. I feel wronged. I miss you.
downloadit-easter-egg-log-9 = I know you must be busy, so you only need to read the first three words.
downloadit-easter-egg-log-10 = You said the moon was beautiful. I said you were more beautiful. You said I had no shame, and I cried!
...
downloadit-browse-aria2next-conf-title = Select aria2 configuration file
